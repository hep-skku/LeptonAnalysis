...
process.TnP_Muon_ID = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    InputFileNames = cms.vstring(#"root://eoscms//eos/cms/store/cmst3/user/botta/TnPtrees/tnpZ_Data.190456-193557.root",
                                 #"file:tnpZ_MC.root"
"/afs/cern.ch/user/d/dhkim/eos/cms/store/group/phys_muon/TagAndProbe/76XtreeProduction/v41/TnPTree_76X_DYLL_M50_MadGraphMLM_part1.root",
"/afs/cern.ch/user/d/dhkim/eos/cms/store/group/phys_muon/TagAndProbe/76XtreeProduction/v41/TnPTree_76X_DYLL_M50_MadGraphMLM_part2.root",
...
#    OutputFileName = cms.string("/afs/cern.ch/user/d/dhkim/eos/cms/store/user/dhkim/TnP_Muon_ID_MC_vpvPlusExpo.root"),
...
#    OutputFileName = cms.string("/afs/cern.ch/user/d/dhkim/eos/cms/store/user/dhkim/TnP_Muon_Iso_MC_vpvPlusExpo.root"),
