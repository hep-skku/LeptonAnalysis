...
EfficiencyBins = cms.PSet(
    ...
    probe_Ele_pt = cms.vdouble(10., 20., 30., 40., 50., 2000.),
    #probe_Ele_pt = cms.vdouble( 10., 2000.),
    #probe_Ele_abseta = cms.vdouble( 0.0, 2.5),
    #probe_Ele_abseta = cms.vdouble(0.0, 0.8, 1.4442, 1.566, 2.0, 2.5 ),
...
process.TnPMeasurement = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
            ...
            #"RooDoubleCBFast::signalResPass(mass,meanP[-0.0,-5.000,5.000],sigmaP[0.956,0.00,15.000],alphaP_1[0.999, 0.0,50.0],nP_1[1.405,0.000,50.000],alphaP_2[0.999, 0.0,50.0],nP_2[1.405,0.000,50.000])",
            ...
            #"RooDoubleCBFast::signalResFail(mass,meanF[-0.0,-5.000,5.000],sigmaF[3.331,0.00,15.000],alphaF_1[1.586, 0.0,50.0],nF_1[0.464,0.000,20.00],alphaF_2[1.586, 0.0,50.0],nF_2[0.464,0.000,20.00])",
            ...
            "signalFractionInPassing[0.5, 0., 1.]"     
            ),
                                                        ),
