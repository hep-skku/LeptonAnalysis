...
process.TnP_Muon_ID = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    InputFileNames = cms.vstring(#"root://eoscms//eos/cms/store/cmst3/user/botta/TnPtrees/tnpZ_Data.190456-193557.root",
                                 #"file:tnpZ_MC.root"
"root://eoscms//eos/cms/store/group/phys_muon/TagAndProbe/76XtreeProduction/v41/TnPTree_76X_DYLL_M50_MadGraphMLM_part1.root",
"root://eoscms//eos/cms/store/group/phys_muon/TagAndProbe/76XtreeProduction/v41/TnPTree_76X_DYLL_M50_MadGraphMLM_part2.root",
#"/afs/cern.ch/user/d/dhkim/eos/cms/store/user/dhkim/TnPTree_76X_DYLL_M50_MadGraphMLM_part1.root",
),
...
#    OutputFileName = cms.string("/afs/cern.ch/user/d/dhkim/eos/cms/store/user/dhkim/TnP_Muon_ID_MC_voigtPlusExpo.root"),
    OutputFileName = cms.string("../TnP_Muon_ID_MC_vpvPlusExpo_5_withJet.root"),
#    OutputFileName = cms.string("/afs/cern.ch/user/d/dhkim/eos/cms/store/user/dhkim/TnP_Muon_ID_MC_vpvPlusExpoMin70.root"),
#    OutputFileName = cms.string("/afs/cern.ch/user/d/dhkim/eos/cms/store/user/dhkim/TnP_Muon_ID_MC_vpvPlusCheb.root"),
    ...
    Expressions = cms.PSet(
      Tight_var = cms.vstring( "Tight_var", "Tight2012==1 && tag_pt > 21 && abs(dB) < 0.2 && abs(dzPV) < 0.5 && pair_nJets30 > 2", "Tight2012", "tag_pt", "dB", "dzPV", "pair_nJets30"),
      ),
...
#    OutputFileName = cms.string("/afs/cern.ch/user/d/dhkim/eos/cms/store/user/dhkim/TnP_Muon_Iso_MC_voigtPlusExpo.root"),
    OutputFileName = cms.string("../TnP_Muon_Iso_MC_vpvPlusExpo_5_withJet.root"),
#    OutputFileName = cms.string("/afs/cern.ch/user/d/dhkim/eos/cms/store/user/dhkim/TnP_Muon_Iso_MC_vpvPlusExpoMin70.root"),
#    OutputFileName = cms.string("/afs/cern.ch/user/d/dhkim/eos/cms/store/user/dhkim/TnP_Muon_Iso_MC_vpvPlusCheb.root"),
    ## More variables
    ...
    Expressions = cms.PSet(
      Tight_Iso_var = cms.vstring( "Tight_Iso_var", "tag_combRelIsoPF04dBeta < 0.15 && tag_pt > 20 && pair_nJets30 > 2", "tag_combRelIsoPF04dBeta", "tag_pt", "pair_nJets30"),
      ),
    ## Cuts: name, variable, cut threshold
    Cuts = cms.PSet(
